...
var module, window, define, renderjson = (function () {
    ...
    function _renderjson(json, indent, dont_indent, show_level, options) {
        ...
        if (json === void 0) {
            return themetext(
                null, my_indent, "keyword", "undefined");
        }
        ...
        if (typeof (json) == "string" && json.length
            ...
            return disclosure(
                ...
                "string", function () {
                    return append(
                        span("string"), themetext(null, my_indent, "string",
                            JSON.stringify(json)
                        ));
                }
            );
        ...
        ].indexOf(json.constructor) >= 0) // Strings, numbers and bools
        {
            return themetext(
                null, my_indent, typeof (json), JSON.stringify(json));
        }

        if (json.constructor == Array) {
            if (json.length == 0) {
                return themetext(
                    null, my_indent, "array syntax", "[]");
            }

            return disclosure(
                "[", options.collapse_msg(json.length), "]", "array",
                function () {
                    var as = append(
                        span("array"),
                    ...
                    for (var i = 0; i < json.length; i++) {
                        append(
                            ...
                            _renderjson(
                                ...
                                indent + "    ", false, show_level - 1, options
                            ),
        ...
        return disclosure(
            "{", options.collapse_msg(Object.keys(json).length), "}", "object",
            function () {
                var os = append(
                    span("object"),
                ...
                for (var i in keys) {
                    ...
                    append(
                        os,
                        themetext(null, indent + "    ", "key", '"' + k + '"',
                            "object syntax", ': '
                        ),
                        _renderjson(
                            options.replacer.call(json, k, json[k]),
                            indent + "    ", true, show_level - 1, options
                        ),
